...
bool P2PNode::send_blocks(int fd,size_t start) {
...
void P2PNode::handle(int fd,std::string remote_host,int remote_port) {
...
bool P2PNode::request_range(int fd,size_t start,std::vector<Block>&out) {
...
P2PNode::P2PNode(Blockchain&b,int lp):bc(b),listen_port(lp) {}

P2PNode::P2PNode(Blockchain&b,const std::string&h,int p):bc(b),peer_host(h),peer_port(p) {}
