...
#ifdef _WIN32
using em_socket_t = SOCKET;
static constexpr em_socket_t EM_INVALID_SOCKET = INVALID_SOCKET;
#else
using em_socket_t = int;
static constexpr em_socket_t EM_INVALID_SOCKET = -1;
#endif
